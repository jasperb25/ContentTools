class ContentTools.EmbedDialog extends ContentTools.DialogUI
    ...
    mount: () ->
        ...
        @_domInput.setAttribute('class', 'ct-embed-dialog__input')
        @_domInput.setAttribute('name', 'url')
        @_domInput.setAttribute(
            'placeholder',
            ContentEdit._('Paste your embed code here') + '...'
            )
        @_domInput.setAttribute('type', 'text')
        @_domView.appendChild(@_domInput)
        ...
        @_domButton.textContent = ContentEdit._('Invoegen')
